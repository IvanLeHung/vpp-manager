                            ...
                            {filteredData.length === 0 && !loading && (
                                <tr>
                                    <td colSpan={6} className="p-10 text-center text-slate-500">
                                        ...
                                        <p className="font-bold">Không tìm thấy Đơn mua sắm nào</p>
                                    </td>
                                </tr>
                            )}
                            {filteredData.map(d => (
                                <tr key={d.id} onClick={() => onViewDetail(d.id)} className="hover:bg-indigo-50/30 cursor-pointer transition group">
                                    ...
                                    <td className="p-4">
                                        ...
                                        {d.expectedDate && <p className="text-[10px] font-black text-amber-600 flex items-center mt-1"><Truck className="w-3 h-3 mr-1"/> GD: {new Date(d.expectedDate).toLocaleDateString('vi-VN')}</p>}
                                    </td>
                                    <td className="p-4 text-center">
