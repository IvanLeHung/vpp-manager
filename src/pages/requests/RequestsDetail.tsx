...
export default function RequestsDetail({
  ...
  const isManagerInChain =
    ...
    data.approvalSteps?.some((s: any) => s.approverId === userId);
  ...
  const isOwnerPending =
    userId === data.requesterId &&
    (data.status === 'PENDING_MANAGER' || data.status === 'PENDING_ADMIN');
            ...
            <div className="flex flex-col gap-4 relative z-10">
              {isApprover ? (
                ...
                <button
                  ...
                  className="w-full py-3.5 bg-indigo-600 text-white rounded-xl font-black hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/20 flex items-center justify-center"
                >
                ...
                <div className="flex flex-col gap-3">
                  {data.status === 'APPROVED' && (
                    <button
                      onClick={() => handleAction('/warehouse/accept', {}, 'Kho đã tiếp nhận phiếu')}
                      className="w-full py-4 bg-teal-600 text-white rounded-xl font-black hover:bg-teal-700 transition shadow-xl shadow-teal-500/30 flex items-center justify-center border-b-4 border-teal-800"
                    >
                  ...
                  {data.status === 'READY_TO_PICK' && (
                    <button
                      ...
                      className="w-full py-4 bg-cyan-600 text-white rounded-xl font-black hover:bg-cyan-700 transition shadow-xl shadow-cyan-500/30 flex items-center justify-center border-b-4 border-cyan-800 text-sm"
                    >
                  ...
                  {data.status === 'PICKING' && (
                    <button
                      ...
                      className="w-full py-4 bg-blue-600 text-white rounded-xl font-black hover:bg-blue-700 transition shadow-xl shadow-blue-500/30 flex items-center justify-center border-b-4 border-blue-800"
                    >
                  ...
                  {data.status === 'READY_TO_HANDOVER' && (
                    <button
                      ...
                      className="w-full py-4 bg-indigo-600 text-white rounded-xl font-black hover:bg-indigo-700 transition shadow-xl shadow-indigo-500/30 flex items-center justify-center border-b-4 border-indigo-800"
                    >
                    ...
                    <div key={step.id} className="relative flex gap-4 pb-8 last:pb-0 items-start">
                      ...
                      <div className="flex-1 min-w-0 pt-1">
                        <div className="flex items-center justify-between mb-0.5">
                          ...
                          {isCurrent && (
                            <span className="text-[9px] bg-indigo-600 text-white px-2 py-0.5 rounded-full font-black uppercase tracking-tighter animate-pulse border border-indigo-700">
                              Đang xử lý
                            </span>
                          )}
                        </div>
