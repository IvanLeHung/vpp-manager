...
const INITIAL_TICKETS: DeliveryTicket[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Kẹp giấy", unit: "Hộp", qtyRequested: 30, qtyApproved: 30, qtyReceived: 20, status: "Chờ bổ sung", note: "Chờ bổ sung 10 hộp do NCC hết hàng" },
  ...
  return (
    <div className="w-full max-w-full min-w-0 overflow-x-hidden p-4 lg:p-6 bg-slate-50 relative flex flex-col gap-6 box-border">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4 mb-10 no-print w-full min-w-0">
        ...
        <div className="flex flex-wrap gap-2.5 justify-start xl:justify-end animate-in fade-in slide-in-from-right-4 duration-700 max-w-full">
